...
<head>
    ...
    <title>Tambah Menu - Sweeco</title>
        ...
        <form action="{{ route('admin.menu.store') }}" method="POST">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="name" class="w-full rounded-xl border-gray-200 bg-gray-50 p-3 focus:outline-none focus:ring-2 focus:ring-red-500" placeholder="Contoh: Kopi Susu Aren" required>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="price" class="w-full rounded-xl border-gray-200 bg-gray-50 p-3 focus:outline-none focus:ring-2 focus:ring-red-500" placeholder="Contoh: 15000" required>
                </div>

                <div class="flex items-center space-x-3 bg-orange-50 p-4 rounded-2xl border border-orange-100">
                    <input type="checkbox" name="is_hot_today" id="is_hot_today" value="1" class="w-5 h-5 rounded text-orange-500 focus:ring-orange-500">
                ...
                <div class="flex space-x-3 pt-4">
                    ...
                    <button type="submit" class="flex-1 py-3 bg-red-500 text-white rounded-xl font-bold hover:bg-red-600 transition-colors">Simpan</button>
                </div>
            </div>
        </form>
    </div>
